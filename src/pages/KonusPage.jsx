...
// 3D Konus komponenti
function Konus3D({ radius, height, tiltAngle, showWireframe }) {
                ...
                {isFullscreen && (
                    <div className="fullscreen-3d-modal" ref={canvasContainerRef}>
                        ...
                        <Canvas shadows style={{ background: 'transparent' }}>
                            ...
                            <pointLight position={[-10, -10, -10]} intensity={0.3} color="#60a5fa" />
                            <Environment preset="city" />
                            <group scale={renderScale}><Konus3D radius={radius} height={height} tiltAngle={tiltAngle} showWireframe={showWireframe} /></group>
                        ...
                        <div className="fullscreen-top-bar">
                            <div className="top-bar-left"><span className="brand-text">▽ Konus 3D</span></div>
