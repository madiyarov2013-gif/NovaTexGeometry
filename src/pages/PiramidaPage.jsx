...
function Piramida3D({ sides, sideLength, height, tiltAngle, showWireframe, showDimensions }) {
                ...
                {isFullscreen && (
                    <div className="fullscreen-3d-modal" ref={canvasContainerRef}>
                        ...
                        <Canvas shadows style={{ background: 'transparent' }}>
                            ...
                            <Environment preset="city" />
                            <group scale={renderScale}>
                                <Piramida3D sides={sides} sideLength={sideLength} height={height} tiltAngle={tiltAngle} showWireframe={showWireframe} showDimensions={true} />
                            </group>
                            {showGrid && (
                        ...
                        <div className="fullscreen-top-bar">
                            <div className="top-bar-left">
                                <span className="brand-text">△ Piramida 3D</span>
                            </div>
                            ...
                            <div className="panel-content">
                                ...
                                <div className="panel-section">
                                    ...
                                    <div className="param-cards">
                                        <div className="param-mini"><span className="param-icon">n</span><span className="param-val">{sides}</span></div>
                                        <div className="param-mini"><span className="param-icon">a</span><span className="param-val">{sideLength}{unitSymbol}</span></div>
                                ...
                                <div className="panel-section">
                                    ...
                                    <div className="calc-mini-grid">
                                        ...
                                        <div className="calc-mini-item"><span className="calc-mini-label">Perimetr</span><span className="calc-mini-value">{calculations.perimeter} {unitSymbol}</span></div>
                                        <div className="calc-mini-item"><span className="calc-mini-label">Yon qirra</span><span className="calc-mini-value">{calculations.lateralEdge} {unitSymbol}</span></div>
                                        <div className="calc-mini-item"><span className="calc-mini-label">Apotema</span><span className="calc-mini-value">{calculations.slantHeight} {unitSymbol}</span></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <aside className="formulas-panel">
                    ...
                    <div className="formulas-section">
                        ...
                        <div className="formula-card">
                            ...
                            <div className="formula-eq">V = (S<sub>asos</sub> × h) / 3</div>
                            <div className="formula-desc">
                                V = ({calculations.baseArea} × {height}) / 3 = {calculations.volume} {unitSymbol}³
                            </div>
                        </div>
                        ...
                        <div className="formula-card">
                            ...
                            <div className="formula-eq">S<sub>yon</sub> = (P × l) / 2</div>
                            <div className="formula-desc">
                                S = ({calculations.perimeter} × {calculations.slantHeight}) / 2 = {calculations.lateralArea} {unitSymbol}²
                            </div>
                        </div>
                        ...
                        <div className="formula-card">
                            ...
                            <div className="formula-eq">l = √(h² + R²)</div>
                            <div className="formula-desc">
                                l = √({height}² + {calculations.radius}²) = {calculations.lateralEdge} {unitSymbol}
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="properties-section">
                        ...
                        <ul className="properties-list">
                            <li>Asosi — muntazam {sides}-burchak</li>
                            <li>Yon yuzalar — {sides} ta teng yonli uchburchak</li>
                            <li>Cho'qqi — barcha yon qirralar kesishadi</li>
